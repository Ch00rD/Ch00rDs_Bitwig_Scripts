...
host.defineController("TomsScripts", "TomsMultiController", "1.0", "e5559d80-bf02-11e3-b1b6-0800200c9a66");
...
function init()
{
   ...
   MultiCon1  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 1", "?0????");
   MultiCon2  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 2", "?1????");
   MultiCon3  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 3", "?2????");
   MultiCon4  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 4", "?3????");
   MultiCon5  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 5", "?4????");
   MultiCon6  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 6", "?5????");
   MultiCon7  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 7", "?6????");
   MultiCon8  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 8", "?7????");
   MultiCon9  = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 9", "?8????");
   MultiCon10 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 10", "?9????");
   MultiCon11 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 11", "?A????");
   MultiCon12 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 12", "?B????");
   MultiCon13 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 13", "?C????");
   MultiCon14 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 14", "?D????");
   MultiCon15 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 15", "?E????");
   MultiCon16 = host.getMidiInPort(0).createNoteInput("MultiCon - Ch 16", "?F????");
