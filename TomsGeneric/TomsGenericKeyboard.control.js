...
host.defineController("TomsScripts", "TomsGenericKeys", "1.0", "b79ced50-bb8b-11e3-a5e2-0800200c9a66");
...
function init()
{
	 TomsGeneric   = host.getMidiInPort(0).createNoteInput("TomsGeneric - Omni", "??????");
   TomsGeneric1  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 1", "?0????");
   TomsGeneric2  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 2", "?1????");
   TomsGeneric3  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 3", "?2????");
   TomsGeneric4  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 4", "?3????");
   TomsGeneric5  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 5", "?4????");
   TomsGeneric6  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 6", "?5????");
   TomsGeneric7  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 7", "?6????");
   TomsGeneric8  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 8", "?7????");
   TomsGeneric9  = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 9", "?8????");
   TomsGeneric10 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 10", "?9????");
   TomsGeneric11 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 11", "?A????");
   TomsGeneric12 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 12", "?B????");
   TomsGeneric13 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 13", "?C????");
   TomsGeneric14 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 14", "?D????");
   TomsGeneric15 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 15", "?E????");
   TomsGeneric16 = host.getMidiInPort(0).createNoteInput("TomsGeneric - Channel 16", "?F????");
