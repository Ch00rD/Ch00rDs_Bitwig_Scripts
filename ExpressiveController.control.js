...
// Modified version of Ch00rD's fork of Thonas Helzle's "TomsMultiBiController" script
//  
//  Enhanced Generic Controller Script for Bitwig Studio with support for:
//  - Using 8 individual MIDI Channels for mapping Poly Aftertouch to Note Expression
...
host.defineController("Ch00rD", 
                      ...
                      "1.0", 
                      "88f990c0-eeac-11e4-b80c-0800200c9a66", 
                      "Ch00rD"
                     );
...
function init() {
    ...
    // 5?? API docs: "This parameter is ignored for non-pitch expressions."
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(0, NoteExpression.TIMBRE_UP, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(1, NoteExpression.TIMBRE_DOWN, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(2, NoteExpression.GAIN_UP, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(3, NoteExpression.GAIN_DOWN, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(4, NoteExpression.PAN_LEFT, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(5, NoteExpression.PAN_RIGHT, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(6, NoteExpression.TIMBRE_UP, 5);
    HiLoResCCs1.assignPolyphonicAftertouchToExpression(7, NoteExpression.TIMBRE_DOWN, 5);
