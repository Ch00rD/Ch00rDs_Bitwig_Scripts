...
host.defineController("CopperLan", "VMidi 1", "1.0", "2E92F140-40BF-11E3-AA6E-0800200C9A66");
host.defineMidiPorts(1, 1);
host.addDeviceNameBasedDiscoveryPair(["VMidi 1"], ["VMidi 1"]);
...
function init()
{
   ...
   VMidi4  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 4", "?3????");
   VMidi5  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 5", "?4????");
   VMidi6  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 6", "?5????");
   VMidi7  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 7", "?6????");
   VMidi8  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 8", "?7????");
   VMidi9  = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 9", "?8????");
   VMidi10 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 10", "?9????");
   VMidi11 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 11", "?A????");
   VMidi12 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 12", "?B????");
   VMidi13 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 13", "?C????");
   VMidi14 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 14", "?D????");
   VMidi15 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 15", "?E????");
   VMidi16 = host.getMidiInPort(0).createNoteInput("VMidi 1 - Channel 16", "?F????");
